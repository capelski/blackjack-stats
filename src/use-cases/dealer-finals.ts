 ...
 * 21.5,8,"10,A / A,10 / A,J / A,Q / A,K / J,A / Q,A / K,A"
 *
 * Score,Probability
...
const scoresCsv = [
  ...
  ...Object.keys(dealerFinals.combinations).map((key) =>
    [
      key,
...
const probabilitiesCsv = [
  ...
  ...Object.keys(dealerFinals.probabilities).map((key) =>
    [key, dealerFinals.probabilities[key]].join(','),
  ),
].join('\n');
