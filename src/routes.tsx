...
import {
  ...
  finalComparisonsGroupedRoute,
  finalComparisonsMatrixRoute,
...
import { FinalComparisonsMatrix } from './components/final-comparisons-matrix.component';
import { FinalComparisons } from './components/final-comparisons.component';
...
const strategyPageNestedRoutes: RouteObject[] = [
  ...
  {
    path: finalComparisonsRoute,
    element: <FinalComparisons />,
    children: [
      { index: true, element: <SearchNavigate to={finalComparisonsMatrixRoute} /> },
      { path: finalComparisonsMatrixRoute, element: <FinalComparisonsMatrix /> },
      { path: finalComparisonsGroupedRoute, element: <FinalComparisonsGrouped /> },
    ],
  },
  { path: expectedResultsRoute, element: <ExpectedResults /> },
  {
