...
Then(
  'there are {int} abstract hands with category {string}',
  function (this: AbstractHandsWorld, count: number, category: HandCategory) {
...
Then(
  'there is an abstract hand with label {string}',
  function (this: AbstractHandsWorld, expectedLabel: string) {
...
Then(
  'there is no abstract hand with label {string}',
  function (this: AbstractHandsWorld, expectedLabel: string) {
    const hand = this.list.find((x) => x.label === expectedLabel);
