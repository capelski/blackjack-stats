Feature: Final comparison
  ...
  Scenario: Final comparison for wins
    ...
    And the final comparison has bet multiplier 1 and probability "0.01861781164971388"
  ...
  Scenario: Final comparison for pushes
    ...
    And the final comparison has bet multiplier 1 and probability "0.017812627440711677"
  ...
  Scenario: Final comparison for losses
    ...
    And the final comparison has bet multiplier 1 and probability "0.024057201498982644"
  ...
  Scenario: Final comparison for blackjack
    ...
    Then the final comparison result equals "win"
    And the final comparison has bet multiplier 1.5 and probability "0.008532659119984349"
  ...
  Scenario: Final comparison with doubling
    ...
    When getting the final comparison of a player score of "19" and a dealer score of "18"
    Then the final comparison result equals "win"
    And the final comparison has bet multiplier 1 and probability "0.014960160975189154"
    When getting the final comparison of a player score of "19" with double bet modifier and a dealer score of "18"
    Then the final comparison result equals "win"
    And the final comparison has bet multiplier 2 and probability "0.0009524141569285474"
  ...
  Scenario: Final comparison with splitting
    ...
    When getting the final comparison of a player score of "19" and a dealer score of "18"
    Then the final comparison result equals "win"
    And the final comparison has bet multiplier 1 and probability "0.016025930508361392"
    When getting the final comparison of a player score of "19" with split modifier and a dealer score of "18"
    Then the final comparison result equals "win"
    And the final comparison has bet multiplier 1 and probability "0.0003099950628956286"
  ...
  Scenario: Final comparison for surrender
    ...
    And the final comparison has bet multiplier 0.5 and probability "0.009079681629385487"
