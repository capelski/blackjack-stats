Feature: Rules
  ...
  Scenario: Actionable
    Then the following actionable scenarios are considered
      ...
      | 3+ cards           | 20    | {}                    | true   |
      | One split pair (A) | 20    | {}                    | false  |
      | One split pair (A) | 14    | {"hitSplitAces":true} | true   |
  ...
  Scenario: Doubling
    Then the following doubling scenarios are considered
      ...
      | One split pair (A) | -      | {"doubling": "all"}                                                   | false  |
      | One split pair (A) | -      | {"doubling": "all", "doublingAfterSplit": true}                       | false  |
      | One split pair (A) | -      | {"doubling": "all", "doublingAfterSplit": true, "hitSplitAces": true} | true   |
