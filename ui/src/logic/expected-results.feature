Feature: Expected results
  ...
  Scenario: Individual expected result
    Then the following individual expected result scenarios are considered
      ...
      | Optimal ROI        | {"splitting": true, "hitSplitAces": true}                         | 15    | 0.1268033369307789    | 0.035706912701928294   | 0                    | 0.09109642422885059    | -0.0558314611428952    |
      ...
      | Optimal ROI        | {"doubling": true, "splitting": true, "doublingAfterSplit": true} | 12    | 0.008695185577054936  | 0.0024485020650241614  | 0                    | 0.006246683512030775   | -0.007657539226111789  |
  ...
  Scenario: Overall expected results
    Then the following overall expected results scenarios are considered
      ...
      | Optimal ROI        | {"doubling": true}                                                | 0.9999999999999736  | 0.4261114967923784  | 0.08310311693853635  | 0.49078538626905893 | -0.031130692205261504 |
      ...
      | Optimal ROI        | {"splitting": true, "hitSplitAces": true}                         | 0.9999999999999737  | 0.42761719064027426 | 0.08504111612055999  | 0.48734169323913956 | -0.036341566123630986 |
      ...
      | Optimal ROI        | {"doubling": true, "splitting": true, "doublingAfterSplit": true} | 0.9999999999999738  | 0.42719554876795307 | 0.08351119378917836  | 0.48929325744284247 | -0.02844509395702491  |
