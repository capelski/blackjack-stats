...
type BreakdownSection = typeof hit | typeof stand;
const breakdownSections: BreakdownSection[] = [stand, hit];
...
export const ActionsBreakdown: React.FC = () => {
  ...
  const sectionRef = section === stand ? standRef : section === hit ? hitRef : undefined;
    ...
    <div className="actions-breakdown">
      {resolvedHand ? (
        <React.Fragment>
          ...
          <ActionsBreakdownHit resolvedHand={resolvedHand} sectionRef={hitRef} />
        </React.Fragment>
      ) : (
